...
const stats = [
    ...
    { title: "Success Case", percentage: 93, con: "Achieving 93% success rate with advanced and personalized cancer treatments." },
    { title: "Happy Patients", percentage: 90, con: "Ensuring 90% patient satisfaction with compassionate and effective cancer care." },
];
        ...
        <div className="flex flex-col items-center text-center space-y-4">
            <div className="relative w-24 h-24">
                <svg className="w-full h-full" viewBox="0 0 100 100">
                    ...
                    />
                    <circle
                        className="text-[#fa3e93] stroke-current"
                        strokeWidth="8"
                        strokeLinecap="round"
                        cx="50"
                        cy="50"
