            ...
            <div className='max-w-full grid lg:grid-cols-12'>
                <div className='bg-black col-span-6 md:order-[1] order-[2]'>
                    ...
                    <div className='space-x-5 px-5'>
                        <button className='bg-white rounded-lg px-10 py-3 font-semibold hover:text-white hover:bg-blue-400'><span className='flex'>Learn More<MdOutlineArrowOutward /></span></button>
                        <button className='bg-black text-white rounded-lg border-2 border-white px-10 py-3 font-semibold hover:text-black hover:bg-white'><span className='flex'>Contact Us<MdOutlineArrowOutward /></span></button>
                    </div>
                </div>
