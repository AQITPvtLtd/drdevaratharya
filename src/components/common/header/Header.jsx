...
const Header = () => {
    ...
    return (
        <div
            className={`overflow-x-clip bg-white header left-0 z-40 top-0 w-full items-center bg-gradient-to-r font-semibold ${sticky
                ? "fixed bg-white !bg-opacity-80 shadow-sticky backdrop-blur-sm transition"
                : ""
                }`}
        >


            <header className="flex justify-around bg-primary">
