...
export const metadata = {
  ...
  keyword: [
    ...
    "cancer treatment facility photos saket",
    "Arya Oncology clinic new delhi",
    "cancer hospital gallery lajpat nagar",
    "patient care photos south delhi",
    "medical oncology center images new delhi",
    "cancer care photos lajpat nagar",
    "oncology setup gallery south delhi"
  ]
};
const page = () => {
  return (
