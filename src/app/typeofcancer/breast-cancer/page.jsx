...
export const metadata = {
    ...
    keywords: [
        ...
        "breast tumor diagnosis new delhi",
        "chemotherapy breast cancer lajpat nagar",
        "radiation therapy breast cancer south delhi",
        "oncology specialist new delhi",
        "breast cancer care lajpat nagar",
        "cancer treatment south delhi",
        "Arya Oncology breast cancer"
    ]
};
const page = () => {
    return (
