...
export const metadata = {
    ...
    keywords: [
        ...
        "prostate cancer treatment new delhi",
        "chemotherapy prostate cancer lajpat nagar",
        "radiation therapy prostate cancer south delhi",
        "oncology specialist new delhi",
        "cancer care lajpat nagar",
        "prostate tumor treatment south delhi",
        "Arya Oncology prostate cancer"
    ]
};
const page = () => {
    return (
