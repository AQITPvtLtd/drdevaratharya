...
export const metadata = {
    ...
    keyword: [
        ...
        "lung cancer diagnosis south delhi",
        "treatment options lung cancer new delhi",
        "chemotherapy lung cancer lajpat nagar",
        "targeted therapy lung cancer south delhi",
        "immunotherapy lung cancer new delhi",
        "lung cancer care lajpat nagar",
        "Arya Oncology lung cancer"
    ]
};
const page = () => {
    return (
