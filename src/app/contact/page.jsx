...
export const metadata = {
  ...
  keyword: [
    ...
    "schedule oncology visit new delhi",
    "cancer treatment booking lajpat nagar",
    "expert oncologist appointment south delhi",
    "Arya Oncology appointment new delhi",
    "oncology doctor booking saket",
    "cancer specialist appointment lajpat nagar"
  ]
};
